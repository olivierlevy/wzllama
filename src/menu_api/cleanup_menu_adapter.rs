...
impl<'a> CleanupMenuRunner<'a> {
    ...
    pub fn menu_tree(&self) -> MenuTree {
        let root = MenuItem::branch("cleanup")
            ...
            .add_submenu(MenuItem::leaf(&self.i18n.t("cleanup.menu_tools")).with_action("cleanup_tools"))
            .add_submenu(MenuItem::leaf(&self.i18n.t("cleanup.menu_models")).with_action("cleanup_models"));
